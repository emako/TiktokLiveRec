...
{
    public static SpiderResult GetResult(string url)
    {
        string? htmlStr = RequestUrl(url);
        SpiderResult result = ExtractData(htmlStr);
    ...
    public static SpiderResult ExtractData(string? htmlStr)
    {
        SpiderResult result = new();
